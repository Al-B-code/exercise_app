...
import com.exerciseapp.exerciseapp.repositories.PrivilegeRepository;
...
public class Dataloader implements
        ApplicationListener<ContextRefreshedEvent> {  // Application Listener on context refreshed event loads the intial data on server start.
