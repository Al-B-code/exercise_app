...
//    private IUserService service; // ??????????
    ...
    @Override
    public UserDetails loadUserByUsername(String email) // i think this is an error in the tutorial. should be username i believe. although i think it has to be this way because of spring security.
